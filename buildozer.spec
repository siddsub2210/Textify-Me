...
requirements = android,hostpython3==3.10.12,python3==3.10.12,kivy==2.2.1,kivymd,Pillow,androidstorage4kivy
...
android.permissions = WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE,READ_MEDIA_IMAGES,READ_MEDIA_VIDEO,READ_MEDIA_AUDIO
